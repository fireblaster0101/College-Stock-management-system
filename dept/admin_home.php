...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            $result0 = $conn->query($sql);
            $row=$result0->fetch_assoc();
            $alert_lab = ($row>0)? "<div class=''><h3 CLASS='alert alert-success text-center'> Labs - ".$row['lab_available']."</h3></div>":"<div class=''><h3 CLASS='alert alert-danger'> NO LABS AVAILABLE </h3></div>";
            echo $alert_lab;
            ?>
        </div>
        <div class="col-md-4">
