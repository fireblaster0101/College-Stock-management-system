        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="container-fluid">
                    <form method="POST" action="./actions/__allocate_labModel.php">
                        ...
                        <div class="row form-group">
                            <div class="col-sm-2">
                                <label class="control-label modal-label">CHOOSE LAB:</label>
                            </div>
                            <div class="col-sm-10">
                                <!--begin option-->
                                <?php
                                ...
                                echo "<select class='form-control id='lab_id' name='lab_id'>";
